...
//String categoriaId
    public String createCategory(String categoriaNombre, String categoria_descripcion, String categoria_activo){
        String query = "insert into categorias (categoria_nombre, categoria_descripcion, categoria_activo) \n" +
                "values(\""+ categoriaNombre+"\", \""+categoria_descripcion+"\",\""+categoria_activo+"\");";
        try {
            Statement statement = conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
            statement.executeUpdate(query);
            output =
                "\" Nueva Categoría - Nombre\" :\" " + categoriaNombre + "\""
                + " , \" Descripcion\" :\" " + categoria_descripcion + "\""
                + " , \" Categoría activa\" :\" " + categoria_activo + "\"";
