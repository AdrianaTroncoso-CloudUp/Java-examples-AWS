...
import smart.notifications.conection.ConnectToClusterRedshift;
...
public class Tracking implements RequestHandler<SNSEvent, Object> {
    ...
    private ConnectToClusterRedshift connectToClusterRedshift = null;
        ...
        for(int i = 0; i < sizeRecordList; i++){
            ...
            try {
                ...
                if(jsonObject.containsKey("eventType")) {
                    ...
                    connectToClusterRedshift = new ConnectToClusterRedshift();
