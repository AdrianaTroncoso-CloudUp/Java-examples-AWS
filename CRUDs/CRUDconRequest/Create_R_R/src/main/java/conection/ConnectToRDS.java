...
public class ConnectToRDS {
    ...
    public String createUser(String nombre, String apaterno, String amaterno, String fecha_nacimiento, String sexo){
        String query = "insert into personas (persona_nombre, persona_apaterno, persona_amaterno, persona_fecha_nacimiento , persona_sexo) \n" +
                "values(\""+nombre+"\", \""+apaterno+"\", \""+amaterno+"\",\""+fecha_nacimiento+"\", \""+sexo+"\");";
        try {
