...
public class Update implements RequestHandler<Map<String, String>, String> {
    ...
    public String handleRequest(Map<String, String> event, Context context) {
        ...
        if ((persona_id.matches("")) == false) {
            ...
            String persona_sexo=event.get("sexo");
            if ((persona_sexo.matches("M") || persona_sexo.matches("F")) == true) {
...
//                                  "values(\"" + persona_nombre + "\", \"" + persona_apaterno + "\", \"" + persona_amaterno + "\",\"" + sqlDateCumple + "\", \"" + persona_sexo + "\");";
                        String query = "update personas set persona_nombre = \""+persona_nombre+"\", persona_apaterno= \""+persona_apaterno+"\" , persona_amaterno = \""+persona_amaterno+"\", persona_fecha_nacimiento = \""+sqlDateCumple+"\", persona_sexo = \""+persona_sexo+"\" where persona_id = \""+persona_id+"\";";
                        ...
                        String output =
                                "\" Usuario editado - ID\": " + persona_id +"\""
                                        ...
                                        + " , \" Fecha de Nacimiento\" :\" " + sqlDateCumple + "\""
                                        + " , \" Sexo:\" :\" " + persona_sexo + "\"";
                        output = "{" + output + "}";
                        resultado = output;
